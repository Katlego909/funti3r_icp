    ...
    <section id="hero" className="py-12 md:py-24">
      ...
      <div className="container flex flex-col-reverse md:flex-row items-center px-2 mx-auto">
        ...
        <div className="flex flex-col mb-8 md:mb-0 space-y-8 md:w-1/2 items-center md:items-start">
          <h1 className="max-w-md text-4xl md:text-4xl font-semibold-100 text-center md:text-left animate-fade-in-up">
            Building a Premium Global Talent Launchpad
          </h1>
          <p className="max-w-sm text-md text-center md:text-left text-gray-700 animate-fade-in-up">
          ...
          <div className="flex gap-4 justify-center md:justify-start animate-fade-in-up">
            <a
              href=""
              className="flex items-center gap-2 px-6 py-3 text-md text-white font-semibold bg-blue-500 rounded-md hover:bg-blue-600 transition duration-300 ease-in-out transform hover:scale-105"
            >
