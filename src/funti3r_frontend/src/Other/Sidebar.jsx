...
import { faTachometerAlt, faBriefcase, faCogs, faSignOutAlt, faTasks, faStickyNote, faList } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div id="sidebar" style={styles.sidebar}>
      ...
      <div className="navbar-links" style={styles.navbarLinks}>
        <div className="navbar-section" style={styles.navbarSection}>Business Navigation</div>
        <ul style={styles.navList}>
          ...
          <li className="sidebar-list-item" style={styles.navItem}>
            <Link to="/dashboard/business-profile" style={styles.navLink}>
              <FontAwesomeIcon icon={faBriefcase} style={styles.icon} /> Business Profile
            </Link>
          </li>
          <li className="sidebar-list-item" style={styles.navItem}>
            <Link to="/dashboard/create-task" style={styles.navLink}>
              <FontAwesomeIcon icon={faTasks} style={styles.icon} /> Create Task
            </Link>
          </li>
          <li className="sidebar-list-item" style={styles.navItem}>
            <Link to="/dashboard/my-listed-tasks" style={styles.navLink}>
              <FontAwesomeIcon icon={faList} style={styles.icon} /> My Listed Tasks
            </Link>
          </li>
          <li className="sidebar-list-item" style={styles.navItem}>
...
const styles = {
  ...
  navLinkHover: {
    ...
    color: '#4a004e', // Purple color on hover
  },
  icon: {
    fontSize: '18px',
